...
class TotalCheckoutWidget extends StatefulWidget {
  ...
  @override
  _TotalCheckoutWidgetState createState() => _TotalCheckoutWidgetState();
}

class _TotalCheckoutWidgetState extends State<TotalCheckoutWidget> {
      ...
      body: GestureDetector(
        ...
        child: Column(
          ...
          children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            functions
                                .totalcheckout(widget.valor, widget.quantidade)
                                .toString(),
                            style: FlutterFlowTheme.of(context).title1,
                          ),
                        ],
            ...
            InkWell(
              onTap: () async {
                setState(() => FFAppState().total = functions.totalcheckout(
                    FFAppState().valor, FFAppState().quant));
